...
<!-- 
            ...
            <form action="../../classes/create_raffle.php" method="post" enctype="multipart/form-data" id="create_raffle_form">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-4">
                  <label for="exampleFormControlInput1">Logo inicio</label>
                  <input type="file" class="form-control-file" accept="image/*" id="logo_image" name="logo_image">
                </div>
              </div>
                <div class="form-row">
                  <div class="form-group col-md-3">
                    <input type="file" class="custom-file-input" id="header_image" readonly accept="image/*" name="header_image">
                    <label class="custom-file-label" for="customFileLang">Imagen Cabecera</label>
                  </div>
                  <div class="form-group col-md-3">
                    <input type="file" class="custom-file-input" id="rigth_image" accept="image/*" readonly name="rigth_image">
                    <label class="custom-file-label" for="customFileLang">Imagen Derecha</label>
                  </div>
                  <div class="form-group col-md-3">
                    <input type="file" class="custom-file-input" id="left_image" accept="image/*" readonly name="left_image">
                    <label class="custom-file-label" for="customFileLang">Imagen Izquerda</label>
                  </div>
                  <div class="form-group col-md-3">
                    <input type="file" class="custom-file-input" id="footer_image" accept="image/*" readonly name="footer_image">
              ...
              <div class="form-row" id="container_photos_hidden" style="display:none;">
                <div class="form-group col-md-4">
                  <label for="exampleFormControlInput1">Selecciones Las Imagenes</label>
  ...
  <script>
    $( () => {
      $("#header_image").prop('disabled', true);
      $("#rigth_image").prop('disabled', true);
      $("#left_image").prop('disabled', true);
      $("#footer_image").prop('disabled', true);
