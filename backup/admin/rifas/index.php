                ...
                <tbody>
                    ...
                    if ($res->num_rows > 0) {
                      while ($row = $res->fetch_assoc()) {
                        ...
                        echo "<td><button class='btn btn-outline-danger btn-event' onclick='removeRaffle({$row['id']})'>Borrar</button> | <button class='btn btn-outline-warning btn-event' onclick='activateRaffle({$row['id']})'>Activar</button></td>";
                        echo "</tr>";
                      }
                    } else {
